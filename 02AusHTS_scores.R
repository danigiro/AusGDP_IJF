...
# 02AusHTS_scores.R
#
# Accuracy indices for the cross-sectional reconciled forecasts for
# Australian GDP time series by quarter, semester and year.
#
# Input files: AusHTS_recf.RData
# Output files: AusHTS_scores.RData
#
...
save(mse, mae, file = "./AusHTS_scores.RData")
